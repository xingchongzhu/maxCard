...
import com.maxcard.contact.UI.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public CaptureActivityHandler(CaptureFragment activity,
	...
	public void handleMessage(Message message) {
		...
		case R.id.restart_preview:
			...
			restartPreviewAndDecode();
			break;
		case R.id.card_decode_succeeded:
			state = State.SUCCESS;
			Bundle bundle1 = message.getData();
			//activity.handleDecode((OCRItems) message.obj);
			break;
		...
		case R.id.launch_product_query:
			...
			ResolveInfo resolveInfo = activity.getContext().getPackageManager()
